...
import NoHostingSection from "../../components/miningfarms/NoHostingSection";
    ...
    <div className="min-h-screen">
      ...
      {isLoading ? (
        ...
        <>
          ...
          <button
            onClick={() => setNoHosting(!noHosting)}
            className="px-4 py-2 text-sm bg-[#3893D0] text-white"
          >
            {noHosting ? "View All Farms" : "View No Hosting"}
          </button>
          {noHosting ? (
            <NoHostingSection />
          ) : (
